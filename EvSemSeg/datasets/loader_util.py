...
_THIS_DIR = Path(__file__).resolve().parent # 获取当前文件所在的路径
remapV3color = pd.read_csv(_THIS_DIR / 'v3_v1_colormap_paper_unified.txt', sep="\t", header=None)
...
remapV3 = pd.read_csv(_THIS_DIR / 'v3_v1.txt', sep="\t", header=None)
